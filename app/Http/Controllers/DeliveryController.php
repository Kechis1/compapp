...
class DeliveryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.deliveries.index', ['pagination' => $this->getPagination($first, $current, $prev, $next, $last), "offset" => $offset, 'count' => $count, "limit" => self::LIMIT, 'pages' => $pages, 'breadcrumbs' => [$breadCrumb], 'dlys' => $dlys]);
    }
