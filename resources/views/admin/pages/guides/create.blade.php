                            ...
                            <section class="mb-4">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 text-right col-form-label"
                                           for="cey_id">{{__('alerts.category')}}: <span
                                                class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <select @change="onChangeCategory" v-model="cey_id" id="cey_id" class="form-control" name="cey_id">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 custom-control custom-checkbox">
                                        <input v-model="gle_active" type="checkbox" name="gle_active" class="custom-control-input" value="1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input v-model="selected.selectedStep.title" type="text"
                                                           name="gss_title"
                                                           class="form-control @error('gss_title') is-invalid @enderror"
                                                           value="{{ old('gss_title') }}" id="gss_title" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label @change="onChangeParameter" class="col-sm-2 text-right col-form-label"
                                                       for="prr_id">{{__('label.parameter')}}: <span
                                                            class="text-danger">*</span></label>
                                                <div class="col-sm-10">
                                                    <select @change="onChangeParameter" v-model="selected.selectedStep.prr_id" id="prr_id" class="form-control" name="prr_id">
                                                        <option value="0" selected>--</option>
                                                        <option v-bind:value="prr.prr_id" v-for="prr in parameters">@{{ prr.pls_name }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <textarea name="gss_description"
                                                          class="form-control @error('gss_description') is-invalid @enderror"
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" name="gsp_choice"
                                                               class="custom-control-input form-control @error('gsp_choice') is-invalid @enderror"
                                                               v-model="selected.selectedStep.choice" value="0" id="gsp_choice0" checked>
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" name="gsp_choice"
                                                               class="custom-control-input form-control @error('gsp_choice') is-invalid @enderror"
                                                               v-model="selected.selectedStep.choice" value="1" id="gsp_choice1">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" name="gsp_choice"
                                                               class="custom-control-input form-control @error('gsp_choice') is-invalid @enderror"
                                                               v-model="selected.selectedStep.choice" value="2" id="gsp_choice2">
                                        ...
                                        <section v-if="selected.selectedChoice!==null">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-2 text-right col-form-label"
                                                       for="gce_title">{{__('label.title')}}:</label>
                                                <div class="col-sm-10">
                                                    <input v-model="selected.selectedChoice.title" type="text"
                                                           name="gce_title"
                                                           class="form-control @error('gle_name') is-invalid @enderror"
                                                           value="{{ old('gce_title') }}" id="gce_title">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-2 text-right col-form-label"
                                                ...
                                                <div class="col-sm-10">
                                                    <select multiple v-model="selected.selectedChoice.pve_id" id="pve_id" class="form-control" name="pve_id">
                                                        <option value="0" selected>--</option>
                                                        <option v-bind:value="pve.pve_id" v-for="pve in selected.selectedChoice.values">@{{ pve.pvs_value }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input v-model="selected.selectedChoice.min" type="text" name="gse_min" class="form-control"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input v-model="selected.selectedChoice.max" type="text" name="gse_max" class="form-control"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="custom-file">
                                                        ...
                                                        <input v-on:change="onFileChange" type="file" name="iae_image" class="custom-file-input"
                                                               id="image">
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea v-model="selected.selectedChoice.advantages" name="gce_pros" class="form-control"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea v-model="selected.selectedChoice.disadvantages" name="gce_cons" class="form-control"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        <input v-model="selected.selectedChoice.default" type="checkbox" name="gse_default"
